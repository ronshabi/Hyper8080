...
void
R_CreateWindow(SDL_Window **win, SDL_Renderer **ren, const char *title, int w,
    int h, float scale)
{
...
void
R_Exit(SDL_Window **win, SDL_Renderer **ren)
{
...
void
R_SetColorBlack(SDL_Renderer **ren)
{
	SDL_SetRenderDrawColor(*ren, 0, 0, 0, 0);
}
void
R_SetColorWhite(SDL_Renderer **ren)
{
	SDL_SetRenderDrawColor(*ren, 0xff, 0xff, 0xff, 0);
}
void
R_SetColorGreen(SDL_Renderer **ren)
{
	SDL_SetRenderDrawColor(*ren, 0, 0xff, 0, 0);
}
void
R_SetColorRed(SDL_Renderer **ren)
{
	SDL_SetRenderDrawColor(*ren, 0xff, 0, 0, 0);
}

void
R_PlacePixel(SDL_Renderer **ren, int x, int y)
{
